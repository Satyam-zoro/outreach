...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PULSE — Outreach Analytics & Statistics" },
      {
        name: "description",
        content:
          "Track, analyse and visualise outreach performance: volume, replies, conversion rates and revenue.",
      },
      { property: "og:title", content: "PULSE — Outreach Analytics & Statistics" },
      {
        property: "og:description",
        content: "Turn outreach activity into measurable growth.",
      },
