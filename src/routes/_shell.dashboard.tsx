...
function OverviewPage() {
  const { totals, previousTotals, facts, prevFacts, funnel, insights, hasData, filters, granularity } = useAnalytics();
    ...
    return (
      <Panel className="mt-6">
        <EmptyState
          ...
          body="Import your outreach history to unlock conversion analytics, channel comparisons and revenue attribution."
        />
      </Panel>
    );
  }
